...
class CustomerPageModel:
    ...
    def fetch_all_data(self):
        ...
        cursor.execute("""
        SELECT Name,Username,Tel,gmail,
        FROM tbl_User
        ORDER BY Name
        """)
    ...
    def insert(self, user_name, user_username, user_password, user_tel, user_gmail):
        cursor = self.conn.cursor()

        try:
            cursor.execute("""
            INSERT INTO tbl_User
            (Name,Username,Tel,gmail,)
            VALUES (?,?,?,?,?)
            """,(user_name, user_username, user_tel, user_gmail))
